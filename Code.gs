...
function sendEmails() {
  ...
  for (k = 1; k < sheetData.length; k++) {
    ...
    styles.even =
      "overflow:hidden;padding:2px 3px;vertical-align:bottom;background-color:rgb(221,242,240);text-align:right;border:1px solid rgb(204,204,204)";
    greet.intro1 =
      "Hello" + firstName + " " + lastName + ", classlist#: " + class_list;
    greet.intro2 = "Please see below your current marks in " + courseNo + ":\n";
